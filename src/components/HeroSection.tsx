  ...
  return (
    <header className="relative flex min-h-[90vh] flex-col items-center justify-center overflow-hidden px-6 pt-16 text-center">
      ...
      <div className="relative z-10 max-w-4xl">
        <span className="mb-6 inline-block text-sm font-bold uppercase tracking-[0.2em] text-primary">
          {overline}
        </span>
        ...
        <div className="flex flex-col items-center gap-6">
          <button className="group flex items-center gap-2 rounded-sm bg-primary px-8 py-4 text-lg font-bold text-black transition-all hover:bg-white hover:shadow-[0_0_30px_rgba(255,255,255,0.3)]">
            {cta}
